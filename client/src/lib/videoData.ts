...
export const VIDEOS: VideoItem[] = [
  ...
  // ═══ 6. 演藝圈流行的清爽秘密 道玄 ═══
  {
    ...
    relatedTreatments: ["laser-hair-removal", "men-aesthetics"],
    isFeaturedHomepage: false,
    typeTags: ["celebrity"],
    originalSortOrder: 6,
    sourcePage: "old_media",
  ...
  // ═══ 9. Talent-A 陽光女孩翹臀 ═══
  {
    ...
    relatedTreatments: ["talent-a", "body-sculpting"],
    isFeaturedHomepage: false,
    typeTags: ["case"],
    originalSortOrder: 9,
    sourcePage: "old_media",
  ...
  // ═══ 11. Talent-A 科技新貴腹肌 ═══
  {
    ...
    relatedTreatments: ["talent-a", "body-sculpting", "men-aesthetics"],
    isFeaturedHomepage: false,
    typeTags: ["case"],
  ...
  // ═══ 13. BOTOX 腋下止汗 ═══
  {
    ...
    relatedTreatments: ["botox", "laser-hair-removal"],
    isFeaturedHomepage: false,
    typeTags: ["treatment"],
  ...
  // ═══ 26. 馬克醫師 AZ疫苗 vlog ═══
  {
    ...
    relatedTreatments: ["nhi-pain-management"],
    isFeaturedHomepage: false,
    typeTags: ["doctor"],
  ...
  // ═══ 35. 吳蕎臻 節食瘦身 ═══
  {
    ...
    relatedTreatments: ["body-sculpting", "talent-a"],
    isFeaturedHomepage: false,
    typeTags: ["doctor"],
  ...
  // ═══ 62. 提美拉黃金埋線拉提 ═══
  {
    ...
    thumbnail: "https://img.youtube.com/vi/PMyafBN4o4A/hqdefault.jpg",
    embedUrl: "https://www.youtube.com/embed/PMyafBN4o4A",
    relatedTreatments: ["thread-lifting", "hyaluronic-acid"],
    isFeaturedHomepage: false,
    typeTags: ["treatment"],
