...
export const IMAGES = {
  ...
  threadLiftHero: img(F.injection, "塑立愛立提線.jpg"),
...
export const TREATMENT_IMG = {
  "Sunmax 膠原蛋白（熊貓針）": img(F.injection, "Sunmax膠原蛋白-熊貓針_cover.jpg"),
  ...
  "塑立愛 少女立提線": img(F.injection, "塑立愛立提線_cover.jpg"),
  "腋下止汗": img(F.injection, "腋下止汗(肉毒注射)_cover.jpg"),
  ...
  "不動刀育髮": img(F.hair, "不動刀育髮_cover.jpg"),
  "頭皮檢測": img(F.hair, "頭皮檢測_cover.jpg"),
  ...
  "水飛梭": img(F.skin, "水飛梭_cover.jpg"),
  "水光注射": img(F.skin, "水光注射_cover.jpg"),
  "Rejuran 麗珠蘭": img(F.skin, "麗珠蘭_cover.jpg"),
  "超級玻尿酸鎖水保濕面膜": img(F.skin, "超級玻尿酸鎖水保濕面膜_cover.jpg"),
  "膠原膜（膠原蛋白面膜）": img(F.skin, "膠原膜.jpg"),
  "法國多酚精萃晶膜": img(F.skin, "法國多酚精萃晶膜_cover.jpg"),
  "安瓶導入": img(F.skin, "安瓶導入_cover.jpg"),
  "AI 光譜治療": img(F.skin, "AI光譜治療_cover.jpg"),
  "AI 智慧皮膚檢測儀": img(F.skin, "AI智慧皮膚檢測儀_cover.jpg"),
  "O2 to Derm 氧氣面罩": img(F.skin, "氧氣面罩_cover.jpg"),
  "無針水光": img(F.skin, "無針水光_cover.jpg"),
  "肌光潔顏蜜": img(F.skin, "肌光潔顏蜜_cover.jpg"),
  "高濃度杏仁酸": img(F.skin, "高濃度杏仁酸_cover.jpg"),
...
export const HAIR_HERO = {
  "non-surgical-hair": img(F.hair, "不動刀育髮.jpg"),
  "scalp-detection": img(F.hair, "頭皮檢測.jpg"),
} as const satisfies Record<string, string>;
...
export const INJECTION_HERO = {
  "sunmax-panda": img(F.injection, "Sunmax膠原蛋白-熊貓針.jpg"),
} as const satisfies Record<string, string>;
...
export const SKIN_HERO = {
  "water-glow": img(F.skin, "水光注射.jpg"),
  hydrafacial: img(F.skin, "水飛梭.jpg"),
  rejuran: img(F.skin, "麗珠蘭.jpg"),
  "super-hyaluronic-mask": img(F.skin, "超級玻尿酸鎖水保濕面膜.jpg"),
  "collagen-mask": img(F.skin, "膠原膜.jpg"),
  "french-polyphenol-mask": img(F.skin, "法國多酚精萃晶膜.jpg"),
  "ampule-infusion": img(F.skin, "安瓶導入.jpg"),
  "ai-spectrum": img(F.skin, "AI光譜治療.jpg"),
  "ai-skin-analysis": img(F.skin, "AI智慧皮膚檢測儀.jpg"),
  "oxygen-mask": img(F.skin, "氧氣面罩.jpg"),
  "needle-free-glow": img(F.skin, "無針水光.jpg"),
  "skin-glow-serum": img(F.skin, "肌光潔顏蜜.jpg"),
  "mandelic-acid-peel": img(F.skin, "高濃度杏仁酸.jpg"),
} as const satisfies Record<string, string>;
