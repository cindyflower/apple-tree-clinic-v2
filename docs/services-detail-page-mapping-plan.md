...
| 快樂門診 — 6 項全部（快樂門診、音樂治療、3DMRA、腦波、HRV、PTG） | `nad-plus-drip`（點滴養生） | 身心門診卻連到點滴頁 | 補「快樂門診」詳情頁；檢測類 4 項可改指功能醫學頁 |
| AI 光譜治療（肌膚管理） | `nad-plus-drip`（點滴養生） | 光療卻連到點滴頁 | 改指肌膚相關頁，或補專屬 |
| VivaBella 薇貝拉（微整注射） | `feminine-laser`（女性私密美學） | 膠原增生劑被導到私密雷射 | 改指微整膠原增生頁（如 `collagen-regeneration`）或補專屬 |
